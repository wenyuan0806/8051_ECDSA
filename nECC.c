...
#define Curve_B_16                                                  \
    {                                                               \
        0xD3, 0x5E, 0xEE, 0x2C, 0x3C, 0x99, 0x24, 0xD8, 0x3D, 0xF4, \
            0x79, 0x10, 0xC1, 0x79, 0x75, 0xE8                      \
    }
#define Curve_B_24                                                      \
    {                                                                   \
        0xB1, 0xB9, 0x46, 0xC1, 0xEC, 0xDE, 0xB8, 0xFE, 0x49, 0x30,     \
            0x24, 0x72, 0xAB, 0xE9, 0xA7, 0x0F, 0xE7, 0x80, 0x9C, 0xE5, \
            0x19, 0x05, 0x21, 0x64                                      \
    }
#define Curve_B_28                                                      \
    {                                                                   \
...
#define Curve_B_32                                                      \
    {                                                                   \
        0x4B, 0x60, 0xD2, 0x27, 0x3E, 0x3C, 0xCE, 0x3B, 0xF6, 0xB0,     \
            ...
            0x55, 0xBD, 0xEB, 0xB3, 0xE7, 0x93, 0x3A, 0xAA, 0xD8, 0x35, \
            0xC6, 0x5A                                                  \
    }
#define Curve_B_48                                                      \
    {                                                                   \
        0xEF, 0x2A, 0xEC, 0xD3, 0xED, 0xC8, 0x85, 0x2A, 0x9D, 0xD1,     \
            0x2E, 0x8A, 0x8D, 0x39, 0x56, 0xC6, 0x5A, 0x87, 0x13, 0x50, \
            0x8F, 0x08, 0x14, 0x03, 0x12, 0x41, 0x81, 0xFE, 0x6E, 0x9C, \
            0x1D, 0x18, 0x19, 0x2D, 0xF8, 0xE3, 0x6B, 0x05, 0x8E, 0x98, \
...
#define Curve_G_16                                                      \
    {                                                                   \
        {                                                               \
            0x86, 0x5B, 0x2C, 0xA5, 0x7C, 0x60, 0x28, 0x0C, 0x2D, 0x9B, \
            0x89, 0x8B, 0x52, 0xF7, 0x1F, 0x16},                        \
        {                                                               \
            0x83, 0x7A, 0xED, 0xDD, 0x92, 0xA2, 0x2D, 0xC0, 0x13, 0xEB, \
                0xAF, 0x5B, 0x39, 0xC8, 0x5A, 0xCF                      \
        }                                                               \
    }
#define Curve_G_24                                                          \
    {                                                                       \
        {                                                                   \
            0x12, 0x10, 0xFF, 0x82, 0xFD, 0x0A, 0xFF, 0xF4, 0x00, 0x88,     \
            0xA1, 0x43, 0xEB, 0x20, 0xBF, 0x7C, 0xF6, 0x90, 0x30, 0xB0,     \
            0x0E, 0xA8, 0x8D, 0x18},                                        \
        {                                                                   \
            0x11, 0x48, 0x79, 0x1E, 0xA1, 0x77, 0xF9, 0x73, 0xD5, 0xCD,     \
                0x24, 0x6B, 0xED, 0x11, 0x10, 0x63, 0x78, 0xDA, 0xC8, 0xFF, \
                0x95, 0x2B, 0x19, 0x07                                      \
        }                                                                   \
    }
#define Curve_G_28                                                          \
...
#define Curve_G_32                                                          \
    {                                                                       \
        {                                                                   \
            ...
            0xE5, 0xE6, 0xBC, 0xF8, 0x47, 0x42, 0x2C, 0xE1, 0xF2, 0xD1,     \
            0x17, 0x6B},                                                    \
        {                                                                   \
            0xF5, 0x51, 0xBF, 0x37, 0x68, 0x40, 0xB6, 0xCB, 0xCE, 0x5E,     \
                0x31, 0x6B, 0x57, 0x33, 0xCE, 0x2B, 0x16, 0x9E, 0x0F, 0x7C, \
                0x4A, 0xEB, 0xE7, 0x8E, 0x9B, 0x7F, 0x1A, 0xFE, 0xE2, 0x42, \
                0xE3, 0x4F                                                  \
        }                                                                   \
    }
#define Curve_G_48                                                          \
    {                                                                       \
        {                                                                   \
            0xB7, 0x0A, 0x76, 0x72, 0x38, 0x5E, 0x54, 0x3A, 0x6C, 0x29,     \
            0x55, 0xBF, 0x5D, 0xF2, 0x02, 0x55, 0x38, 0x2A, 0x54, 0x82,     \
            0xE0, 0x41, 0xF7, 0x59, 0x98, 0x9B, 0xA7, 0x8B, 0x62, 0x3B,     \
            0x1D, 0x6E, 0x74, 0xAD, 0x20, 0xF3, 0x1E, 0xC7, 0xB1, 0x8E,     \
            0x37, 0x05, 0x8B, 0xBE, 0x22, 0xCA, 0x87, 0xAA},                \
        {                                                                   \
            0x5F, 0x0E, 0xEA, 0x90, 0x7C, 0x1D, 0x43, 0x7A, 0x9D, 0x81,     \
                0x7E, 0x1D, 0xCE, 0xB1, 0x60, 0x0A, 0xC0, 0xB8, 0xF0, 0xB5, \
                0x13, 0x31, 0xDA, 0xE9, 0x7C, 0x14, 0x9A, 0x28, 0xBD, 0x1D, \
                0xF4, 0xF8, 0x29, 0xDC, 0x92, 0x92, 0xBF, 0x98, 0x9E, 0x5D, \
...
#define Curve_N_16                                                  \
    {                                                               \
        0x15, 0xA1, 0x38, 0x90, 0x1B, 0x0D, 0xA3, 0x75, 0x00, 0x00, \
            0x00, 0x00, 0xFE, 0xFF, 0xFF, 0xFF                      \
    }
#define Curve_N_24                                                      \
    {                                                                   \
        0x31, 0x28, 0xD2, 0xB4, 0xB1, 0xC9, 0x6B, 0x14, 0x36, 0xF8,     \
            0xDE, 0x99, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
            0xFF, 0xFF, 0xFF, 0xFF                                      \
    }
#define Curve_N_28                                                      \
    {                                                                   \
...
#define Curve_N_48                                                      \
    {                                                                   \
        0x73, 0x29, 0xC5, 0xCC, 0x6A, 0x19, 0xEC, 0xEC, 0x7A, 0xA7,     \
            0xB0, 0x48, 0xB2, 0x0D, 0x1A, 0x58, 0xDF, 0x2D, 0x37, 0xF4, \
            0x81, 0x4D, 0x63, 0xC7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, \
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF              \
    }
...
// data uint8_t l_tmp[NUM_ECC_DIGITS] _at_ 0x30;
...
static void vli_mmod_fast(uint8_t *p_result, uint8_t *p_product)
{
    ...
    l_tmp[22] = p_product[38];
    l_tmp[23] = p_product[39];
    l_tmp[24] = p_product[40];
    l_tmp[25] = p_product[41];
    l_tmp[26] = p_product[42];
    l_tmp[27] = p_product[43];
    l_carry = vli_add(p_result, p_result, l_tmp);
    ...
    /* d1 */
    l_tmp[0] = p_product[28];
    l_tmp[1] = p_product[29];
    l_tmp[2] = p_product[30];
    l_tmp[3] = p_product[31];
    l_tmp[4] = p_product[32];
    l_tmp[5] = p_product[33];
    l_tmp[6] = p_product[34];
    l_tmp[7] = p_product[35];
    l_tmp[8] = p_product[36];
    l_tmp[9] = p_product[37];
    l_tmp[10] = p_product[38];
    l_tmp[11] = p_product[39];
    l_tmp[12] = p_product[40];
    l_tmp[13] = p_product[41];
    l_tmp[14] = p_product[42];
    l_tmp[15] = p_product[43];
    l_tmp[16] = p_product[44];
    l_tmp[17] = p_product[45];
    l_tmp[18] = p_product[46];
    l_tmp[19] = p_product[47];
    l_tmp[20] = p_product[48];
    l_tmp[21] = p_product[49];
    l_tmp[22] = p_product[50];
    l_tmp[23] = p_product[51];
...
// uint8_t data l_tmp[NUM_ECC_DIGITS] _at_ 0x30;
...
{
    uint8_t u1[NUM_ECC_DIGITS];
    uint8_t u2[NUM_ECC_DIGITS];
    ...
    l_points[0] = (EccPoint *)NULL;
    l_points[1] = (EccPoint *)&curve_G;
    l_points[2] = (EccPoint *)p_publicKey;
    l_points[3] = (EccPoint *)&l_sum;
